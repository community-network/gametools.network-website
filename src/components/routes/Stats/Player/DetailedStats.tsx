      ...
      return (
        <Spacing>
          <Box>
            ...
            <GridContainer>
              <div>
                <h3>{numberFormat.format(stats?.skill)}</h3>
                <p>{t("stats.detailed.skill")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.scorePerMinute)}</h3>
              ...
              <div>
                <h3>{numberFormat.format(stats?.killAssists)}</h3>
              ...
              <div>
                <h3>{numberFormat.format(stats?.loses)}</h3>
                <p>{t("stats.detailed.losses")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.revives)}</h3>
                <p>{t("stats.detailed.revives")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.repairs)}</h3>
                <p>{t("stats.detailed.repairs")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.infantryKillDeath)}</h3>
                <p>{t("stats.detailed.infantryKillDeath")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.infantryKillsPerMinute)}</h3>
                <p>{t("stats.detailed.infantryKillsPerMinute")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.heals)}</h3>
              ...
              <div>
                <h3>{numberFormat.format(stats?.avengerKills)}</h3>
                <p>{t("stats.detailed.avengerKills")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.saviorKills)}</h3>
                <p>{t("stats.detailed.saviorKills")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.roundsPlayed)}</h3>
                <p>{t("stats.detailed.roundsPlayed")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.awardScore)}</h3>
                <p>{t("stats.detailed.awardScore")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.bonusScore)}</h3>
                <p>{t("stats.detailed.bonusScore")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.squadScore)}</h3>
                <p>{t("stats.detailed.squadScore")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.longestHeadShot)}</h3>
                <p>{t("stats.detailed.longestHeadShot")}</p>
              </div>
              <div>
                <h3>{numberFormat.format(stats?.highestKillStreak)}</h3>
        ...
        <Spacing>
          <Box>
            ...
            <GridContainer>
              ...
              <div>
                <h3>{numberFormat.format(stats?.quits)}</h3>
