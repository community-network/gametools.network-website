...
function App() {
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Game tools");
}
...
/* harmony import */ var _html__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./html */ "./src/server/html.ts");
...
server.use(express__WEBPACK_IMPORTED_MODULE_1___default().static('dist'));
server.get('/', (req, res) => {
    const body = (0,react_dom_server__WEBPACK_IMPORTED_MODULE_2__.renderToString)(react__WEBPACK_IMPORTED_MODULE_0__.createElement(_App__WEBPACK_IMPORTED_MODULE_4__.default));
    res.send((0,_html__WEBPACK_IMPORTED_MODULE_3__.default)({
        body
    }));
});
